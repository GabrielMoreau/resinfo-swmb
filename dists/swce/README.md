...
| `ViewTCBPrivilege`               | Disable Trusted Computing Base Privilege - Enable use the global variable $Global:SWMB_Custom.TCBPrivilege - [W11 STIG V-253481](https://www.stigviewer.com/stigs/microsoft-windows-11-security-technical-implementation-guide/2025-05-15/finding/V-253481) |
| `ViewCreateTokenObject`          | Disable Create a Token Object all accounts - Enable use the global variable $Global:SWMB_Custom.CreateTokenObject - [W11 STIG V-253486](https://www.stigviewer.com/stigs/microsoft-windows-11-security-technical-implementation-guide/2025-05-15/finding/V-253486) |
