...
Function SWMB_GetOSVersionColor {
	...
	# See ./get-ubr
	$UBR = @(
		# BeginAutoEdit - UBR - a7a2e813cc214fccf27d9a122bce59b7
		@{Os = '11'; DisplayVersion = '25H2'; MajorMinor = '10.0'; Build = 26200; UBR = 7627; Level = 0} # https://learn.microsoft.com/en-us/windows/release-health/windows11-release-information
		@{Os = '11'; DisplayVersion = '25H2'; MajorMinor = '10.0'; Build = 26200; UBR = 7623; Level = 1} # https://learn.microsoft.com/en-us/windows/release-health/windows11-release-information
		@{Os = '11'; DisplayVersion = '25H2'; MajorMinor = '10.0'; Build = 26200; UBR = 7462; Level = 2} # https://learn.microsoft.com/en-us/windows/release-health/windows11-release-information
		@{Os = '11'; DisplayVersion = '25H2'; MajorMinor = '10.0'; Build = 26200; UBR = 7309; Level = 3} # https://learn.microsoft.com/en-us/windows/release-health/windows11-release-information
		@{Os = '11'; DisplayVersion = '24H2'; MajorMinor = '10.0'; Build = 26100; UBR = 7627; Level = 0} # https://learn.microsoft.com/en-us/windows/release-health/windows11-release-information
		@{Os = '11'; DisplayVersion = '24H2'; MajorMinor = '10.0'; Build = 26100; UBR = 7623; Level = 1} # https://learn.microsoft.com/en-us/windows/release-health/windows11-release-information
		@{Os = '11'; DisplayVersion = '24H2'; MajorMinor = '10.0'; Build = 26100; UBR = 7462; Level = 2} # https://learn.microsoft.com/en-us/windows/release-health/windows11-release-information
		@{Os = '11'; DisplayVersion = '23H2'; MajorMinor = '10.0'; Build = 22631; UBR = 6494; Level = 0} # https://learn.microsoft.com/en-us/windows/release-health/windows11-release-information
		@{Os = '11'; DisplayVersion = '23H2'; MajorMinor = '10.0'; Build = 22631; UBR = 6491; Level = 1} # https://learn.microsoft.com/en-us/windows/release-health/windows11-release-information
		...
		@{Os = '10'; DisplayVersion = '22H2'; MajorMinor = '10.0'; Build = 19045; UBR = 6811; Level = 3} # https://learn.microsoft.com/en-us/windows/release-health/release-information
		@{Os = '10'; DisplayVersion = '21H2'; MajorMinor = '10.0'; Build = 19044; UBR = 6811; Level = 3} # https://learn.microsoft.com/en-us/windows/release-health/release-information
		# EndAutoEdit
	)
